...
function makeBusiness(overrides: Partial<SiteBusiness> = {}): SiteBusiness {
  const base: SiteBusiness = {
    ...
    items: [
      { id: "i1", name: "Truffle cake", description: "Dark chocolate", price: 1200, image_url: "https://example.test/i1.jpg", category: "Cakes", is_active: true },
    ],
    services: [
      { id: "s1", name: "Custom cake consult", description: "Plan your cake", price: 500, duration_minutes: 30, category: null, image_url: null, is_active: true },
    ],
