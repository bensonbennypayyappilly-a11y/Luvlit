 ...
 * Source: Wikimedia Commons "India outline.svg" (public-domain-grade geographic
 * boundary data — this is the physical shape of the country, not creative work).
 */
...
export type DiscoveryImageData = {
  src: string;
  alt: string;
  region: string;
};
